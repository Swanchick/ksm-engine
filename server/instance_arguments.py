...
class InstanceArguments(Database):
    def start(self):
        ...
        self._execute("CREATE TABLE IF NOT EXISTS instance_arguments("
                      "instance_id INTEGER,"
    ...
    def add_argument(self, instance_id: int, argument: str):
        ...
        self._execute("INSERT INTO instance_arguments ("
                      "instance_id, "
                      "argument) "
                      "VALUES (%s, %s)",
    ...
    def remove_argument(self, instance_id: int, argument: str):
        ...
        self._execute("DELETE FROM instance_arguments "
